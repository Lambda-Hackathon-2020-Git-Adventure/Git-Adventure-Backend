...
exports.seed = function(knex) {
  ...
  return knex('decisions').insert([
    ...
    {name: 'Run away', story_id: 1, author_id: 1, text: "You barely escape the ambush but end up on the trail where you started. How will you preceed?", video: "", image: "", timer: 5000},
    {name: 'Attack the goblin archers first', story_id: 1, author_id: 1, text: "The archers are unable to react to the close range attack. The sword goblins wreck your day though. They rob you and leave you to die on the side of the trail. You need to find help soon.", video: "", image: "", timer: 5000},
    {name: 'Attack the goblins carrying swords first', story_id: 1, author_id: 1, text: "Smart move. The archers are unable to react to the close range attack while you deal with the sword ghablins. You slay three of the goblins and injure 1 of the archers.", video: "", image: "", timer: 5000},
    ...
    {name: 'Run away', story_id: 1, author_id: 1, text: "You barely escape the ambush but end up on the trail where you started. How will you preceed?", video: "", image: "", timer: 5000},
    {name: 'Attack', story_id: 1, author_id: 1, text: "You manage to deal with the sword goblins. The archers wreck your day though. They rob you and leave you to die on the side of the trail. You need to find help soon.", video: "", image: "", timer: 5000},
    {name: 'Try to bribe', story_id: 1, author_id: 1, text: "They take your money and walk away. You continue along the path. Suddenly you see an arrow whiz past your head. You are now moving target practice for the goblin archers.", video: "", image: "", timer: 5000},
  ], 'id');
};
